...
public class Program
{
    ...
    {
        var group1 = new Group() { Id = new Guid("8b0c5d41-858d-4d63-9a17-5e166c785baa"), Name = "G1" };
        var group2 = new Group() { Id = new Guid("a9f1e0e2-7f77-4d98-b2ce-492ba48bf8e5"), Name = "G2" };
